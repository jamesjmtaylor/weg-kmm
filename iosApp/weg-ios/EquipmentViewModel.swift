...
class EquipmentViewModel: NSObject, ObservableObject {
    ...
    func loadEquipment(forceReload: KotlinBoolean) {
        sdk.getEquipment(equipmentType: EquipmentType.land, page: 0, forceReload: forceReload, completionHandler: { equipment, error in
